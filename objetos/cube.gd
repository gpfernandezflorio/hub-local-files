...
func gen(argumentos):
	...
	var resultado = h3.nuevo_mesh_rep([
		...
		h3.nueva_cara([3,2,6,7], uvs_v),h3.nueva_cara([0,3,7,4], uvs_v),h3.nueva_cara([1,5,6,2], uvs_v),
		h3.nueva_cara([0,4,5,1], uvs_v),h3.nueva_cara([0,1,2,3], uvs_v),h3.nueva_cara([7,6,5,4], uvs_v)
	], uvs,
	"cubo")
	return resultado
